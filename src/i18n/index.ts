...
const messages: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    'strategy.bfs-merge': 'BFS 区域合并',
    'strategy.bfs-mergeDesc': 'Lab匹配后BFS自动识别相邻相似区域并合并，阈值自适应',
    'strategy.bfsThreshold': '合并阈值',
    'strategy.bfsAuto': '自动',
    'notify.confirm': '确定',
    'notify.cancel': '取消',
    'lang.switch': '🌐',
    ...
    'tab.image': '图片转拼豆',
    'tab.text': '文字转拼豆',
    'text.placeholder': '输入要转换的文字...',
    'text.fontSize': '字号',
    'text.generate': '生成拼豆',
    'text.clear': '清空',
    'text.comingSoon': '功能开发中，敬请期待...',
    'text.colorMode': '颜色模式',
    'text.gradient': '渐变',
    'text.solid': '纯色',
    'text.charColor': '第{index}字颜色',
    'text.charColorTip': '点击设置第{index}个字的颜色',
    'text.font': '字体',
    'text.charCellSize': '每字格数',
    'text.charCellUnit': '格/字',
    'text.preview': '预览原图',
  },
  'en': {
    ...
    'strategy.bfs-merge': 'BFS Region Merge',
    'strategy.bfs-mergeDesc': 'Lab match then BFS auto-merges adjacent similar regions, adaptive threshold',
    'strategy.bfsThreshold': 'Merge Threshold',
    'strategy.bfsAuto': 'Auto',
    ...
    'crop.reset': 'Reset',
    'crop.btn': '✂️ Crop',
    'tab.image': 'Image to Beads',
    'tab.text': 'Text to Beads',
    'text.placeholder': 'Enter text to convert...',
    'text.fontSize': 'Font Size',
    'text.generate': 'Generate',
    'text.clear': 'Clear',
    'text.comingSoon': 'Coming soon...',
    'text.colorMode': 'Color Mode',
    'text.gradient': 'Gradient',
    'text.solid': 'Solid',
    'text.charColor': 'Char {index} Color',
    'text.charColorTip': 'Click to set color for character {index}',
    'text.font': 'Font',
    'text.charCellSize': 'Beads/Char',
    'text.charCellUnit': '/char',
  ...
  'zh-TW': {
    ...
    'strategy.bfs-merge': 'BFS 區域合併',
    'strategy.bfs-mergeDesc': 'Lab匹配後BFS自動識別相鄰相似區域並合併，閾值自適應',
    'strategy.bfsThreshold': '合併閾值',
    'strategy.bfsAuto': '自動',
    'notify.confirm': '確定',
    'notify.cancel': '取消',
    'lang.switch': '🌐',
    ...
    'tab.image': '圖片轉拼豆',
    'tab.text': '文字轉拼豆',
    'text.placeholder': '輸入要轉換的文字...',
    'text.fontSize': '字號',
    'text.generate': '生成拼豆',
    'text.clear': '清空',
    'text.comingSoon': '功能開發中，敬請期待...',
    'text.colorMode': '顏色模式',
    'text.gradient': '漸變',
    'text.solid': '純色',
    'text.charColor': '第{index}字顏色',
    'text.charColorTip': '點擊設定第{index}個字的顏色',
    'text.font': '字體',
    'text.charCellSize': '每字格數',
    'text.charCellUnit': '格/字',
    'text.preview': '預覽原圖',
  },
}
